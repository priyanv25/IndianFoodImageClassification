    ...
    def stages():
        ...
        for img in tqdm(os.listdir(verify_dir)):
            ...
            for cnt in contours:
                ...
                sum1=sum1+pyval 
##            print(sum1)
            calo1="The calorie per 100gm in the predicted food item is {}".format(sum1)
...
##        print(model_out)
        ...
        def accuracy_graph():
                ...
                L=float(model_out[11])
                
                dic={'biriyani':A,'bisibelebath':B,'butternaan':C,'chaat':D,'chappati':E, 'dhokla':F,'dosa':G,'idly':H,'noodles':I,'upma':J,'poori':K,'samosa':L}
                #print(dic)
                algm = list(dic.keys()) 
                ...
                plt.bar(algm, accu, color ='maroon',  
                        width = 0.3) 
                  
                plt.xlabel("Comparision") 
                plt.ylabel("Accuracy Level") 
                plt.title("Accuracy Comparision between different Food....")
    ##            plt.savefig('2matrix.png', dpi=300, bbox_inches='tight')
                plt.show()
        ...
        if str_label == 'biriyani':
            ...
            calo = tk.Label(text=calo1, background="darkcyan", fg="white", font=("", 15))
...
##            calo="The calorie in the predicted food item is {}".format(sum1)            
            ...
            caloried="The calorie in the predicted food item is {}".format(cald)    
##            calo="The calorie in the predicted food item is {}".format(sum1)            
            calo = tk.Label(text=caloried, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=4, padx=10, pady=10)            
            calo = tk.Label(text=predss, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=5, padx=10, pady=10)            
            button = tk.Button(text="Exit", command=exit)
...
##            calo="The calorie in the predicted food item is {}".format(sum1)            
            ...
            caln=140+random.randint(20,50)
            calorien="The calorie in the predicted food item is {}".format(caln)                
            calo = tk.Label(text=calorien, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=4, padx=10, pady=10)            
            calo = tk.Label(text=predss, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=5, padx=10, pady=10)            
            button = tk.Button(text="Exit", command=exit)
...
##            calo="The calorie in the predicted food item is {}".format(sum1)            
            ...
            cals=150+random.randint(15,40)
            calorie="The calorie in the predicted food item is {}".format(cals)            
            calo = tk.Label(text=calorie, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=4, padx=10, pady=10)            
            calo = tk.Label(text=predss, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=5, padx=10, pady=10)            
            button = tk.Button(text="Exit", command=exit)
